...
CREATE TABLE TB_USUARIO_GRUPO_USUARIO (
    ...
    CONSTRAINT FK_ID_PF_PESSOA1 FOREIGN KEY (ID_GRUPO_USUARIO) REFERENCES TB_PESSOA(IDENT)
);
...
CREATE TABLE tb_grupo_usuario (
    ...
    desc_grupo VARCHAR(11),
    PRIMARY KEY (IDENT),
    CONSTRAINT FK_ID_PF_PESSOA2 FOREIGN KEY (IDENT) REFERENCES TB_PESSOA(IDENT),
    CONSTRAINT FK_DOM_GENERO_PF2 FOREIGN KEY (id_dom_situacao) REFERENCES TB_DOMINIO(IDENT)
);
